    ...
    <div className="w-full h-full flex">
      <div className="lg:m-3 xs:m-0 lg:rounded-lg xs:rounded-none bg-gradient-to-t from-green-900 via-bg to-bg flex flex-col gap-12 justify-center items-center w-full">
        <div className="flex flex-col gap-2 items-center mt-16">
          <h1 className="text-[48px] font-bold text-white tracking-wide text-center">
            Welcome to{" "}
            <span className="bg-gradient-to-l from-bg via-bg to-green-700 text-center">
              FileTask
            </span>
          </h1>
          <p className="text-[16px] text-gray-300 tracking-wide text-center">
        ...
        <div className="flex flex-col items-center justify-center">
          <label
            ...
            className="flex flex-col bg-transparent items-center justify-center lg:w-96 w-full text-center h-64 border-2 border-gray-600 rounded-2xl cursor-pointer hover:border-green-700 transition"
          >
